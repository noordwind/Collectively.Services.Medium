# Coolector.Services.Medium

####**Keep your commune clean in just a few clicks.**

|Branch             |Build status                                                  
|-------------------|-----------------------------------------------------
|master             |[![master branch build status](https://api.travis-ci.org/noordwind/Coolector.Services.Medium.svg?branch=master)](https://travis-ci.org/noordwind/Coolector.Services.Medium)
|develop            |[![develop branch build status](https://api.travis-ci.org/noordwind/Coolector.Services.Medium.svg?branch=develop)](https://travis-ci.org/noordwind/Coolector.Services.Medium/branches)
...
In order to run the **Coolector.Services.Medium** you need to have installed:
...
```
git clone https://github.com/noordwind/Coolector.Services.Medium
cd Coolector.Services.Medium/Coolector.Services.Medium
...
Please note that the following solution will only run the Medium Service which is merely one of the many parts required to run properly the whole Coolector system.
...
**Solution structure**
----------------
- **Coolector.Services.Medium** - core and executable project via *dotnet run* command.
- **Coolector.Services.Medium.Tests** - unit & integration tests executable via *dotnet test* command.